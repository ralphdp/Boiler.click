...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans relative overflow-hidden">
      ...
      <main
        id="main-content"
        className="flex min-h-screen w-full max-w-5xl mx-auto flex-col items-center justify-center pt-36 pb-16 px-4 sm:py-36 sm:px-8 md:px-32 relative z-10"
        role="main"
        aria-label={t("ui.ariaLabels.homepageMainContent")}
      >
        {/* Left Content */}
        <div className="flex-1 w-full max-w-2xl">
          ...
          >
            ...
            <div className="w-full mb-4 relative">
              ...
              {/* Eddie positioned absolutely within QuickStart area */}
              <div className="absolute bottom-[-20px] right-[-20px] z-10">
                <TooltipProvider>
                  <Tooltip open={true}>
                    <TooltipTrigger asChild>
                      <div className="relative w-32 h-32 sm:w-60 sm:h-60 cursor-pointer">
            ...
            <div
              ...
              role="group"
              aria-label={t("ui.ariaLabels.homepageActionButtons")}
            >
              <Button asChild className="w-auto">
                <Link
                  href="/about"
                  aria-label={t("ui.ariaLabels.learnMoreAboutBoiler")}
                >
              ...
              <Button asChild variant="outline" className="w-auto">
                <a
                  ...
                  aria-label={t("ui.ariaLabels.viewOnGitHub")}
                >
